...
function Unisexperfumes(){
    ...
    return (
        <>
        <div className={styles.unisexperfumes}>
            <h1 className={styles.header}>Unisex Perfumes</h1>
            <div className={styles.unisexcon} ref={containerRef}>
                <div className={`${styles.unisexcards} ${styles.snapsalign}`}>
